...
;
 ...
 if (file_exists($_SERVER['DOCUMENT_ROOT']."/img/fotos/".$datos_p[0].".jpg")) {
        print <<<R003
		</td><tr>
		<tr><td>
        <table align="center" border="0" cellpadding="0" cellspacing="1" width="550">
...
;
	 ...
	 print <<<R003
		...
		<tr>
			<td align="center" colspan="2" style="font-family:Arial;font-size:20px;"><br>
				<p>Esta planilla solo tiene fines informativos, no es valida sin la fotografia del titular y sin el sello y Firma de la Unidad Regional de Admision y Control de Estudios.
				</p>
				<p>
            </td>
        </tr>
...
$Cdat->iniciarTransaccion("Inicio Inscripcion: ".$_POST['exp_e']." - ");
...
if($todas_mat > 5){// Intenta inscribir mas asignaturas de lo permitido.
	#echo "SOLO PUEDE INSCRIBIR tres ASIGNATURAS <BR>";
	#die();
	$formOK=false;
	echo '<script languaje=\"javacript\">alert("Lo siento, estas intentando inscribir mas asignaturas de lo permitido.\n\nEl maximo permitido para este lapso es cinco(5) asignaturas, por favor ingrese nuevamente al sistema y asegurese de seleccionar correctamente sus asignaturas.");window.close();</script>';
}
